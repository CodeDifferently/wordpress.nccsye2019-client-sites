...
function load_js() {
    ...
    register_and_enqueue_script('jquery-migrate', 'https://code.jquery.com/jquery-migrate-1.2.1.js', true);
    register_and_enqueue_script('bootstrap-4.3.1', 'https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.js', true); // bootstrap 4.3.1

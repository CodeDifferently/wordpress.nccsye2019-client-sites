...
function insertAnchor($path, $additional_attributes='') {
    echo getInsertAnchor($path, $additional_attributes);
}
...
function getInsertLink($path, $additional_attributes='') {
    return "<link href=\"" . get_template_directory_uri () . $path . "\" " . $additional_attributes .">";
}

function getInsertAnchor($path, $additional_attributes='') {
